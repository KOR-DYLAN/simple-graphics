...
static SGL_ALWAYS_INLINE sgl_q11_ext_t sgl_generic_bilinear_interpolation(sgl_q11_ext_t v1, sgl_q11_ext_t v2, sgl_q11_ext_t v3, sgl_q11_ext_t v4, sgl_q11_ext_t d)
{
    ...
    v = p3 + sgl_q11_mul(d, p4);
    v = p2 + sgl_q11_mul(d, v);
    v = p1 + sgl_q11_mul(d, v);
...
static SGL_ALWAYS_INLINE void sgl_generic_resize_bicubic_line_stripe(int32_t row, sgl_bicubic_data_t *data) {
    ...
    for (col = 0; col < d_width; ++col) {
        ...
        for (ch = 0; ch < bpp; ++ch) {
            v1 = sgl_generic_bilinear_interpolation(SGL_INT_TO_Q11(src_y1x1[ch]), SGL_INT_TO_Q11(src_y1x2[ch]), SGL_INT_TO_Q11(src_y1x3[ch]), SGL_INT_TO_Q11(src_y1x4[ch]), (sgl_q11_ext_t)p);
            v2 = sgl_generic_bilinear_interpolation(SGL_INT_TO_Q11(src_y2x1[ch]), SGL_INT_TO_Q11(src_y2x2[ch]), SGL_INT_TO_Q11(src_y2x3[ch]), SGL_INT_TO_Q11(src_y2x4[ch]), (sgl_q11_ext_t)p);
            v3 = sgl_generic_bilinear_interpolation(SGL_INT_TO_Q11(src_y3x1[ch]), SGL_INT_TO_Q11(src_y3x2[ch]), SGL_INT_TO_Q11(src_y3x3[ch]), SGL_INT_TO_Q11(src_y3x4[ch]), (sgl_q11_ext_t)p);
            v4 = sgl_generic_bilinear_interpolation(SGL_INT_TO_Q11(src_y4x1[ch]), SGL_INT_TO_Q11(src_y4x2[ch]), SGL_INT_TO_Q11(src_y4x3[ch]), SGL_INT_TO_Q11(src_y4x4[ch]), (sgl_q11_ext_t)p);
