...
static const sgl_test_resize_t resize_test_vector[] = {
    ...
    { .width = 2560, .height = 1440, .method = SGL_TEST_RESIZE_NEAREST,        .num_threads = SGL_TEST_THREADPOOL_COUNT_2   },

    { .width  = 640, .height =  480, .method = SGL_TEST_RESIZE_NEAREST,        .num_threads = SGL_TEST_THREADPOOL_COUNT_4,  },
    { .width = 1280, .height =  720, .method = SGL_TEST_RESIZE_NEAREST,        .num_threads = SGL_TEST_THREADPOOL_COUNT_4   },
    { .width = 1920, .height = 1080, .method = SGL_TEST_RESIZE_NEAREST,        .num_threads = SGL_TEST_THREADPOOL_COUNT_4   },
    { .width = 2560, .height = 1440, .method = SGL_TEST_RESIZE_NEAREST,        .num_threads = SGL_TEST_THREADPOOL_COUNT_4   },

    { .width  = 640, .height =  480, .method = SGL_TEST_RESIZE_NEAREST,        .num_threads = SGL_TEST_THREADPOOL_COUNT_8,  },
    { .width = 1280, .height =  720, .method = SGL_TEST_RESIZE_NEAREST,        .num_threads = SGL_TEST_THREADPOOL_COUNT_8   },
...
#   if defined(SGL_CFG_HAS_SIMD)
    ...
    { .width = 2560, .height = 1440, .method = SGL_TEST_RESIZE_NEAREST_SIMD,   .num_threads = SGL_TEST_THREADPOOL_COUNT_2   },

    { .width  = 640, .height =  480, .method = SGL_TEST_RESIZE_NEAREST_SIMD,   .num_threads = SGL_TEST_THREADPOOL_COUNT_4,  },
    { .width = 1280, .height =  720, .method = SGL_TEST_RESIZE_NEAREST_SIMD,   .num_threads = SGL_TEST_THREADPOOL_COUNT_4   },
    { .width = 1920, .height = 1080, .method = SGL_TEST_RESIZE_NEAREST_SIMD,   .num_threads = SGL_TEST_THREADPOOL_COUNT_4   },
    { .width = 2560, .height = 1440, .method = SGL_TEST_RESIZE_NEAREST_SIMD,   .num_threads = SGL_TEST_THREADPOOL_COUNT_4   },

    { .width  = 640, .height =  480, .method = SGL_TEST_RESIZE_NEAREST_SIMD,   .num_threads = SGL_TEST_THREADPOOL_COUNT_8,  },
    { .width = 1280, .height =  720, .method = SGL_TEST_RESIZE_NEAREST_SIMD,   .num_threads = SGL_TEST_THREADPOOL_COUNT_8   },
    { .width = 1920, .height = 1080, .method = SGL_TEST_RESIZE_NEAREST_SIMD,   .num_threads = SGL_TEST_THREADPOOL_COUNT_8   },
    { .width = 2560, .height = 1440, .method = SGL_TEST_RESIZE_NEAREST_SIMD,   .num_threads = SGL_TEST_THREADPOOL_COUNT_8   },
#   endif  /* !SGL_CFG_HAS_SIMD */
#endif  /* !SGL_CFG_HAS_THREAD */
...
#   endif  /* !SGL_CFG_HAS_SIMD */
    ...
    { .width  = 640, .height =  480, .method = SGL_TEST_RESIZE_BICUBIC,         .num_threads = SGL_TEST_THREADPOOL_COUNT_1, },
    { .width = 1280, .height =  720, .method = SGL_TEST_RESIZE_BICUBIC,         .num_threads = SGL_TEST_THREADPOOL_COUNT_1, },
...
#   endif  /* !SGL_CFG_HAS_SIMD */
    ...
    { .width = 1280, .height =  720, .method = SGL_TEST_RESIZE_BICUBIC,         .num_threads = SGL_TEST_THREADPOOL_COUNT_2  },
    { .width = 1920, .height = 1080, .method = SGL_TEST_RESIZE_BICUBIC,         .num_threads = SGL_TEST_THREADPOOL_COUNT_2  },
    { .width = 2560, .height = 1440, .method = SGL_TEST_RESIZE_BICUBIC,         .num_threads = SGL_TEST_THREADPOOL_COUNT_2  },

    { .width  = 640, .height =  480, .method = SGL_TEST_RESIZE_BICUBIC,         .num_threads = SGL_TEST_THREADPOOL_COUNT_4, },
    { .width = 1280, .height =  720, .method = SGL_TEST_RESIZE_BICUBIC,         .num_threads = SGL_TEST_THREADPOOL_COUNT_4  },
    { .width = 1920, .height = 1080, .method = SGL_TEST_RESIZE_BICUBIC,         .num_threads = SGL_TEST_THREADPOOL_COUNT_4  },
    { .width = 2560, .height = 1440, .method = SGL_TEST_RESIZE_BICUBIC,         .num_threads = SGL_TEST_THREADPOOL_COUNT_4  },

    { .width  = 640, .height =  480, .method = SGL_TEST_RESIZE_BICUBIC,         .num_threads = SGL_TEST_THREADPOOL_COUNT_8, },
    { .width = 1280, .height =  720, .method = SGL_TEST_RESIZE_BICUBIC,         .num_threads = SGL_TEST_THREADPOOL_COUNT_8  },
    { .width = 1920, .height = 1080, .method = SGL_TEST_RESIZE_BICUBIC,         .num_threads = SGL_TEST_THREADPOOL_COUNT_8  },
    ...
    for (i = 0; i < (int32_t)(sizeof(resize_test_vector) / sizeof(sgl_test_resize_t)); ++i) {
        ...
        for (repeat = 0; repeat < REPEAT_TEST_COUNT; ++repeat) {
            ...
            case SGL_TEST_RESIZE_NEAREST:
                (void)sgl_generic_resize_nearest(pool[num_threads], NULL, dst, resize_test_vector[i].width, resize_test_vector[i].height, src->buf, src->width, src->height, src->bpp);
                break;
            case SGL_TEST_RESIZE_BILINEAR:
                ...
                break;
            case SGL_TEST_RESIZE_BICUBIC:
                (void)sgl_generic_resize_bicubic(pool[num_threads], NULL, dst, resize_test_vector[i].width, resize_test_vector[i].height, src->buf, src->width, src->height, src->bpp);
                break;
#if defined(SGL_CFG_HAS_SIMD)
