#ifndef SGL_OSAL_POSIX_H_
#define SGL_OSAL_POSIX_H_
...
/* Spinlock */
static inline void sgl_osal_spinlock_init(sgl_osal_spinlock_t *spinlock)
{
    pthread_spin_init(spinlock, PTHREAD_PROCESS_PRIVATE);
}

static inline void sgl_osal_spinlock_lock(sgl_osal_spinlock_t *spinlock)
{
    pthread_spin_lock(spinlock);
}

static inline void sgl_osal_spinlock_unlock(sgl_osal_spinlock_t *spinlock)
{
    pthread_spin_unlock(spinlock);
}

static inline void sgl_osal_spinlock_destroy(sgl_osal_spinlock_t *spinlock)
{
